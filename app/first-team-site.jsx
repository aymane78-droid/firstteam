  ...
  return (
    <div>
      ...
      <section style={{
        ...
        <div className="hero-inner" style={{ maxWidth: 1400, margin: "0 auto", padding: "120px 24px 80px", width: "100%", position: "relative", zIndex: 2 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }} className="hero-grid">
            <div>
              ...
              <div className="animate-fade-up delay-3 hero-cta" style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
              ...
              <div className="animate-fade-up delay-4 hero-stats" style={{ display: "flex", gap: 20, marginTop: 40 }}>
                {[
      ...
      <section style={{ padding: "80px 24px", maxWidth: 1400, margin: "0 auto" }}>
        <div className="section-head" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 40 }}>
          <div>
      ...
      <section style={{
        ...
        <div className="offense-cta-section" style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2 }}>
      ...
      <section style={{ padding: "32px 24px", background: "var(--ft-dark)", borderBottom: "1px solid var(--ft-border)" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto" }}>
          <div className="filter-bar" style={{ display: "flex", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
            <div className="filter-search" style={{ position: "relative", flex: "1 1 300px", maxWidth: 400 }}>
  ...
  return (
    <div style={{ paddingTop: 80 }}>
      ...
      <section style={{ padding: "48px 24px 80px", maxWidth: 1400, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(min(280px, 100%), 1fr))", gap: 28 }}>
          {MERCH.map((item, i) => (
      ...
      {selected && (
        <div onClick={() => setSelected(null)} style={{
          ...
          <div onClick={e => e.stopPropagation()} className="animate-scale product-modal" style={{
            ...
            <div className="product-modal-body" style={{ padding: 32 }}>
  ...
  return (
    <div className="offense-page" style={{ paddingTop: 80, background: "#1a120a", color: "#F5E6D3" }}>
      ...
      <section style={{
        ...
        <div className="offense-hero-inner" style={{ maxWidth: 900, margin: "0 auto", padding: "120px 24px 80px", position: "relative", zIndex: 2, textAlign: "center" }}>
      ...
      <section style={{ padding: "80px 24px", maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gap: 20 }}>
          {OFFENSE_EPISODES.map((ep, i) => (
            <div key={ep.id} className={`card-hover animate-fade-up delay-${i + 1} episode-card`} style={{
              ...
              <div className="episode-play" style={{ width: 56, height: 56, borderRadius: "50%", background: "rgba(212,115,26,0.2)", border: "2px solid #D4731A", display: "flex", alignItems: "center", justifyContent: "center", color: "#D4731A", flexShrink: 0 }}>
                <Play />
              </div>
            </div>
          ))}
  ...
  return (
    <div style={{ paddingTop: 80 }}>
      <section style={{
        ...
        <div className="travels-hero-inner" style={{ maxWidth: 1400, margin: "0 auto", position: "relative", zIndex: 2 }}>
    ...
    <>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .hero-inner { padding: 84px 16px 60px !important; }
          ...
          .section-head { flex-direction: column !important; align-items: flex-start !important; gap: 16px !important; margin-bottom: 24px !important; }
          .offense-hero-inner { padding: 84px 16px 60px !important; }
          .episode-card { grid-template-columns: 1fr !important; padding: 20px !important; }
          .episode-play { display: none !important; }
          .product-modal { border-radius: 12px !important; max-height: 88vh !important; overflow-y: auto !important; }
          .product-modal-body { padding: 20px !important; }
          .offense-cta-section { padding: 60px 16px !important; }
          .filter-bar { flex-direction: column !important; align-items: stretch !important; }
          .filter-search { max-width: 100% !important; flex: 1 1 auto !important; }
          .travels-hero-inner { padding: 60px 16px 40px !important; }
          .section-v80 { padding-top: 48px !important; padding-bottom: 48px !important; }
        }

        /* ── Small mobile ── */
        @media (max-width: 480px) {
          .hero-inner  { padding: 80px 12px 48px !important; }
          .offense-hero-inner { padding: 80px 12px 48px !important; }
          .offense-cta-section { padding: 48px 12px !important; }
        }
      `}</style>
