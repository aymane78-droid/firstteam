  ...
  return (
    <header className="header-wrap" style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        {/* Icône mail — mobile uniquement */}
        <a
          href="mailto:firstteam@influxcrew.com?subject=Contact%20depuis%20le%20site%20First%20Team"
          className="header-mail-icon"
          aria-label="Nous contacter"
          title="Nous contacter"
          style={{ color: "#FE0000", padding: 10, textDecoration: "none" }}
        >
        ...
        {/* CTA texte — desktop uniquement */}
        <a href="mailto:firstteam@influxcrew.com?subject=Contact%20depuis%20le%20site%20First%20Team" className="pill-btn pill-btn-red header-contact-cta" style={{ fontSize: 13, padding: "10px 20px" }}>
          Nous contacter →
        </a>
        <button
